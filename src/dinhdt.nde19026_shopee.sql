...
AS SELECT c.CustomerName,c.customerAddress,o.totalbill,o.orderDate ,sa.AddressDetails `Receive Address`,s.shippingmethodName,p.paymentMethodName,o.orderStatus
FROM customer c inner join shippingAddress sa on sa.customerID = c.customerID inner join orders o on o.shippingAddressID = sa.shippingAddressID ;

-- procedure input infor product
delimiter //
create procedure inputInforProduct(in productName nvarchar(255),in productPrice decimal(13,2), in productSalePrice decimal(13,2), in productQuantityInStock int, in quantitySold int , in productDescription nvarchar(255),in productStatus nvarchar(30))
begin
